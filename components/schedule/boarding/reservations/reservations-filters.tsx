...
import { RESERVATION_STATUS_LABELS, type ReservationStatusFilter } from "@/lib/constants/reservation-filters"
        ...
        <div className={cn("flex flex-1 flex-wrap items-center gap-2", className)}>
            ...
            <Select
                ...
                onValueChange={(value) => {
                    ...
                    updateParams({
                        status: value as ReservationStatusFilter,
                    })
                }}
            >
                <SelectTrigger className="h-9 w-[160px]">
                    <SelectValue>
                        {initialStatus === "all"
                            ? RESERVATION_STATUS_LABELS.all
                            : `Status: ${RESERVATION_STATUS_LABELS[initialStatus]}`}
                    </SelectValue>
                </SelectTrigger>
                ...
                <SelectContent>
                    ...
                    <SelectItem value="pending">
                        {RESERVATION_STATUS_LABELS.pending}
                    </SelectItem>

                    <SelectItem value="confirmed">
                        {RESERVATION_STATUS_LABELS.confirmed}
                    </SelectItem>

                    <SelectItem value="checked_in">
                        {RESERVATION_STATUS_LABELS.checked_in}
                    </SelectItem>
