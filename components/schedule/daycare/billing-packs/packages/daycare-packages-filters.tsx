...
import type { DaycarePackageStatusFilter } from "@/lib/constants/daycare-billing-filters"
...
type DaycarePackagesFiltersProps = {
  initialSearch?: string
  initialStatus: DaycarePackageStatusFilter
...
export function DaycarePackagesFilters({
  initialSearch = "",
  initialStatus,
  onLoadingChange,
  className,
}: DaycarePackagesFiltersProps) {
    ...
    >
      <div className="relative w-full max-w-sm">
        ...
        <Input
          ...
          aria-label="Search daycare packages"
        />
      </div>
      ...
      <Select
        ...
        onValueChange={(value) => {
          ...
          updateParams({
            status: value as DaycarePackageStatusFilter,
          })
        }}
      >
